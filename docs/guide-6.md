...
## <img src="https://caelum.s-ul.eu/Ei5MWQfu.png" width="25" alt="Water"> Ice Golem
...
## <img src="https://caelum.s-ul.eu/Fv9zr7o3.png" width="25"> Job Fighting Spirit
![Knight Fighting Spirit Medal](https://ringabel.net/bdfe/img/medals/knight_fight.jpg) ![Black Mage Fighting Spirit Medal](https://ringabel.net/bdfe/img/medals/black_mage_fight.jpg) ![White Mage Fighting Spirit Medal](https://ringabel.net/bdfe/img/medals/white_mage_fight.jpg) ![Thief Fighting Spirit Medal](https://ringabel.net/bdfe/img/medals/thief_fight.jpg) ![Ranger Fighting Spirit Medal](https://ringabel.net/bdfe/img/medals/ranger_fight.jpg) 

The normal effects of these medals are different depending on the job, and only activate if you are in the respective job. They have no set effect. They each have 1 high stat and low stats everywhere else.

Job|Normal Effct|High Stat|Comments
---|---|:-:|---
![Knight](https://caelum.s-ul.eu/4mCTfFw6.gif) | Aggro generation +15%<br>(up to 90%) | HP | Useful when you need that extra push to maintain aggro.
![Black Mage](https://caelum.s-ul.eu/9Cfbpmce.gif) | Limit break +600<br>(up to 3600) | Matk | Probably better to have special power medals unless you can hit cap without them (depends on party setup and boss).
![White Mage](https://caelum.s-ul.eu/DkAtu3w5.gif) | Auto healing power +5<br>(up to 30) | Spirit | While it gives absolute power on auto healing amount, poison moth medals could be more desirable for higher defensive stats while usable for all jobs. Easier to obtain, however.
![Thief](https://caelum.s-ul.eu/K1su7ZFm.gif) | Auto attack power +7<br>(up to 42) | Patk | Absolute destructive power for thieves.
![Ranger](https://caelum.s-ul.eu/PWHtYVMH.gif) | Poison power +4%<br>(up to 24%) | Crit. Rate | General survival medals are probably better.

## <img src="https://caelum.s-ul.eu/Fv9zr7o3.png" width="25"> Job Faith
![Knight Faith Medal](https://ringabel.net/bdfe/img/medals/knight_faith.jpg) ![Black Mage Faith Medal](https://ringabel.net/bdfe/img/medals/black_mage_faith.jpg) ![White Mage Faith Medal](https://ringabel.net/bdfe/img/medals/white_mage_faith.jpg) ![Thief Faith Medal](https://ringabel.net/bdfe/img/medals/thief_faith.jpg) ![Ranger Faith Medal](https://ringabel.net/bdfe/img/medals/ranger_faith.jpg) 

The set effects of these medals are different depending on the job, and only activate if you are in the respective job. They have no normal effect. They each have 1 high stat and low stats everywhere else. The effects of these medals all activate (with chance) when being attacked.

Job|Set Effct|High Stat|Comments
---|---|:-:|---
![Knight](https://caelum.s-ul.eu/4mCTfFw6.gif) | [20 per link]% to reduce damage by [6 per link]%<br>(Up to 100% to reduce damage by 30%) | HP | Due to their high stats, better than all family damage reduction medals when you are using a full set. However, the effect starts to fall off when you need to slot in debuff resistance medals.
![Black Mage](https://caelum.s-ul.eu/9Cfbpmce.gif) | [15 per link]% to reduce special reload by [10 per link]s<br>(Up to 75% to reduce special reload by 50s) | Matk | Useful when you are having trouble getting specials ready when needed. However you have to receive attacks consistently.
![White Mage](https://caelum.s-ul.eu/DkAtu3w5.gif) | [20 per link]% to buff self with Mind 1 for 15s<br>(Up to 100% to buff self with Mind 1 for 15s) | Spirit | Mind 1 raises both auto and special powers by 50. If being targetted is expected, it can be better than Fighting Spirit medals. However Fighting Spirit, Ice Golem and damage reduction medals are more popular.
![Thief](https://caelum.s-ul.eu/K1su7ZFm.gif) | [10 per link]% to reduce current auto reload to 0 *when evaded an attack*<br>(Up to 50% to reduce current auto reload to 0) | Patk | Arguably useable on situations where auto reloads get extended. However thieves generally do not get targetted as much as other jobs. Note that only thief medals are different from others since they require thieves to evade instead of to get hit.
![Ranger](https://caelum.s-ul.eu/PWHtYVMH.gif) | [15 per link]% to extend debuffs by [2 per link]s<br>(Up to 75% to extend debuffs by 10s) | Crit. Rate | While nice on paper, rangers generally do not get attacked often. Debuff extension bows are usually enough on keeping debuffs on the enemies.

# <img src="https://caelum.s-ul.eu/Fv9zr7o3.png" width="25"> Debuff Resist
![Bleed Medal](https://ringabel.net/bdfe/img/medals/bleed_resist.jpg) ![Poison Medal](https://ringabel.net/bdfe/img/medals/poison_resist.jpg) ![Blind Medal](https://ringabel.net/bdfe/img/medals/blind_resist.jpg) ![Waste Medal](https://ringabel.net/bdfe/img/medals/waste_resist.jpg) ![Seal Medal](https://ringabel.net/bdfe/img/medals/seal_resist.jpg) ![Burn Medal](https://ringabel.net/bdfe/img/medals/burn_resist.jpg) ![Slow Medal](https://ringabel.net/bdfe/img/medals/slow_resist.jpg) ![Stop Medal](https://ringabel.net/bdfe/img/medals/stop_resist.jpg) ![Bind Medal](https://ringabel.net/bdfe/img/medals/bind_resist.jpg) ![Stat-down Medal](https://ringabel.net/bdfe/img/medals/status_resist.jpg) 

They are special medals that increase in potency as you evolve them from 1-star to 6-star. However, the trick is that they need copies of 1-star versions to evolve. For example to fuly evolve a Bleed Medal to 6-star, you need 16 pieces of 1-star Bleed Medals.

Rarity | Debuff Resist | Medals to Evolve | Cumulative Number of Medals
---|---|---|---
1 | 5 | 1 | 1
2 | 8 | 2 | 2
3 | 10 | 3 | 4
...
They are usually available from event rare encounters or event medal alchemy.

# Disclaimers and References
* Images are provided and hosted by [eku53ru](https://ringabel.net/bdfe/?medals_shiny)
* Kaillera
* [ねこれあ。-BDFE-](https://bdfe.ladygo.net/matome/484)